...
<div class="lion"><img src="/img/pera_beats.jpg" width="30" height="30" alt=""/></div>PERA BEATS</a></div></div>
        ...
        <div class="nav_sect" style="border-left:none"><a href="./Event">EVENTS</a></div>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <p><?php echo "<a href=\"view/".$events['event']['event_hash']."\">".$events['event']['event_id']." ".$events['event']['event_topic'] ; ?></a></p>
