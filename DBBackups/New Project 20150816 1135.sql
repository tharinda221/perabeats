...
INSERT INTO `pb_news` (`news_id`,`news_topic`,`news_small_desc`,`news_desc`,`news_content`,`news_main_img`,`news_date_added`,`news_time_added`,`pb_log_user_lg_id`,`news_hash`) VALUES 
 (1,'Women’s Badminton On A Roll','desc','After two days of blistering and beautiful display of football, UOM and EUSL qualified for the final of Mora Cup organized by the University of Moratuwa.','LargeDesc\n','1.jpg','2014-06-02','17:34:00',1,'colors-night'),
 (2,'UNIVERSITY OF SRI JAYEWARDENEPURA COLOURS NIGHT','Desc','After two days of blistering and beautiful display of football, UOM and EUSL qualified for the final of Mora Cup organized by the University of Moratuwa.','LargeDesc\n','carrom_0.jpg','2014-05-11','12:00:00',1,'news-two'),
 (3,'IUC Badminton Champions','Inter university Badminton Matches were held at UoP as the hosting University','Inter university Badminton Matches were held at UoP as the hosting University','The Inter University Badminton Championship 2015 reached its climax today at University of Peradeniya courts with University of Moratuwa and University of Kelaniya taking the honours in men’s and women’s category respectively.\n<br><br>\nIn a brief day that consisted only finals and consolation matches for the third place, fans witnessed the unexpected in the form of women from Kelaniya. J’Pura, the undisputed champions in women’s arena went in to the finals as favourites. But high spirited Kelaniya entered the final falsifying the speculations prior to the tournament. The end result was more than scintillating for the fans. J’Pura tried hard to return the cup home but all went in vain owing to exceptional performance by Kelaniya ladies who stole the championship from their opponents. The final score was 3-1 in favour of Kelaniya.\n<br><br>\nIn men’s final, fans witnessed a replay from the last year with same opponents facing each other once again this year as well. The result too was similar with favourites Mora retaining the championship. J’Pura looking to avenge their defeat last year had to return home empty handed. The win goes to the book as the fourth in five years for team Mora.\n<br><br>\nIn the women’s consolation match for the third place Mora and Pera had their fair share of show down. In a match that lasted until the fifth game, Mora was able to edge over Pera and deny the host the third place.\n\n','15_08_16_bdm.jpg','2015-08-16','09:31:00',1,'iuc-2015-badminton');
...
INSERT INTO `pb_university` (`u_id`,`u_name`,`u_address`,`u_email`) VALUES 
 ...
 (2,'University of Sri Jayawardanapura',NULL,NULL);
